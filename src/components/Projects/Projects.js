  ...
  const ProjectList = [
    {
      id: 1,
      img: chakra,
      title: "WE Wear (ASOS.COM clone)",
      description:
        "Discover fashion redefined at WE Wear, your ultimate destination for premium clothing and timeless style. Drawing inspiration from the acclaimed ASOS.com, we curate collections that epitomize elegance and embrace the essence of true fashion. Unveil your style potential today with WE Wear, where every garment tells a unique story and every choice is a step towards sartorial excellence",
      tech_stack: [html, css3, javascript],
      github_url: "https://github.com/Biswajit2595/impartial-honey-6054",
      demo_url: "https://stunning-frangipane-07bc9c.netlify.app/",
    },
    {
      id: 2,
      img: chakra,
      title: "Your Doc",
      description:
        "Meet YourDoc: Your go-to web app for hassle-free doctor's appointments. Simplifying healthcare scheduling, YourDoc puts you in control. Quickly find and book appointments with your chosen doctors, focusing on convenience and personalized care. Experience a new era of streamlined healthcare management with YourDoc.",
      tech_stack: [html, css3, javascript, react, chakra],
      github_url: "https://github.com/Biswajit2595/earthy-smell-701",
      demo_url: "https://radiant-sprinkles-ed694a.netlify.app/",
    },
    {
      id: 3,
      img: chakra,
